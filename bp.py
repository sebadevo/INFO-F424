...
def solve_bp_lp(instance_name):
    ...
    repaired_objective = calculator.compute_int_solution(size, cap, weight, scheme=0) # scheme 0 corresonds to best-fit, 1 for first-fit
...
class Calculator:
    def __init__(self, filename):  # elements
        ...
        # This constraint is to remove the symetry from the problem.
        @self.model.Constraint(self.model.b)
